...
- Android version is based on [react-native-pjsip-builder](https://github.com/rinble/react-native-pjsip-builder)
- iOS version is based on [Vialer-pjsip-iOS](https://github.com/VoIPGRID/Vialer-pjsip-iOS)

## Installation

- [iOS](https://github.com/rinble/react-native-pjsip/blob/master/docs/installation_ios.md)
- [Android](https://github.com/rinble/react-native-pjsip/blob/master/docs/installation_android.md)
...
1. [Startup](https://github.com/rinble/react-native-pjsip/blob/master/docs/startup.md)
2. [Accounts](https://github.com/rinble/react-native-pjsip/blob/master/docs/accounts.md)
3. [Calls](https://github.com/rinble/react-native-pjsip/blob/master/docs/calls.md)
4. [Settings](https://github.com/rinble/react-native-pjsip/blob/master/docs/settings.md)
